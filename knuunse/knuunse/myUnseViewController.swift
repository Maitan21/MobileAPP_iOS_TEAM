...
class myUnseViewController: UIViewController {
    ...
    var constellations = [Constellation(name: "양 자리", image: UIImage(named: "aries.jpg"), startDate: "3/21", stopDate: "4/19"),
         Constellation(name: "황소 자리", image: UIImage(named: "taurus.jpg"), startDate: "04/20", stopDate: "05/20"),
         Constellation(name: "쌍둥이 자리", image: UIImage(named: "gemini.jpg"), startDate: "05/21", stopDate: "06/20"),
         Constellation(name: "게 자리", image: UIImage(named: "cancer.jpg"), startDate: "06/21", stopDate: "07/22"),
         Constellation(name: "사자 자리", image: UIImage(named: "leo.jpg"), startDate: "07/23", stopDate: "08/22"),
         Constellation(name: "처녀 자리", image: UIImage(named: "virgo.jpg"), startDate: "08/23", stopDate: "09/22"),
         Constellation(name: "천칭 자리", image: UIImage(named: "libra.jpg"), startDate: "09/23", stopDate: "10/22"),
         Constellation(name: "전갈 자리", image: UIImage(named: "scorpio.jpg"), startDate: "10/23", stopDate: "11/21"),
         Constellation(name: "사수 자리", image: UIImage(named: "sagittarius.jpg"), startDate: "11/22", stopDate: "12/21"),
         Constellation(name: "염소 자리", image: UIImage(named: "capricorn.jpg"), startDate: "12/22", stopDate: "01/19"),
         Constellation(name: "물병 자리", image: UIImage(named: "aquarius.jpg"), startDate: "01/20", stopDate: "02/18"),
       Constellation(name: "물고기 자리", image: UIImage(named: "pisces.jpg"), startDate: "02/19", stopDate: "03/20")]
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
         ...
         let calendar = Calendar.current
               ...
               //                day: 12)
                       let dateComponents = DateComponents(calendar: calendar,
                                                           year: (ViewController.mUser!.birthYear),
                                                           month: (ViewController.mUser!.birthMonth),
                                                           day: (ViewController.mUser!.birthDay))
                       ...
                       //        let currentMonth = calendar.component(.month, from: date)
                               ...
                               for (index , constellation) in constellations.enumerated() {
                                   if constellation.checkInterval(dateComponent: dateComponents) {
                                       myUnseImageView.image = constellation.image
                                       myUnseSubContentView.text = constellation.name
                                       myUnseContentView.text = contents[(index + currentDay + (ViewController.mUser!.birthDay)) % contents.count]
